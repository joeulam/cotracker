...
export default function Dashboard() {
  ...
  async function transactionGrab() {
    const auth = getAuth();
    const user = auth.currentUser;
    if (user) {
      const uid = user.uid;
      const docRef = await (collection(db, "user", uid, "newTransactions"));
  ...
  const [transactionCards, settransactionCards] = useState<string[] | null>([]); // All tags
  ...
  async function fetchData() {
    ...
    const transactionData = await transactionGrab();
  ...
  const recentTransactionCard = transactionCards.map((entry) => (
    <Container>
    ...
    <MantineProvider defaultColorScheme="light">
      <div className="">
        <div className="flex flex-row">
          <div className="h-[100vh] bg-[#4D4D4D] w-[15vw] basis-1/6">
          ...
          <div className="ml-[3vw] basis-4/6">
              <div>
              ...
              <div className="bg-white pr-[20vw] pl-[2vw] pt-[2vh] pb-[2vh] rounded-[15px] mt-[4vh]">
                <h2 className="text-[30px]">Your Budget Left:</h2>
          ...
          <div className="basis-3/6">
            <h2 className="text-[24px] text-center">Recent Transactions</h2>
            <Stack
              align="stretch"
              justify="center"
              gap="md"
